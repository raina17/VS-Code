...
if len(top_coin_volume_list) > 1:
    buy_coin = top_coin_volume_list[0]
    buy_coin_price = client.ticker_price(top_coin_volume_list[0])['price']
else:
    buy_coin = 0
    buy_coin_price = 0
    print('no coin')

print(f'buy coin is {buy_coin}')
print(f'buy coin price is {buy_coin_price}')
